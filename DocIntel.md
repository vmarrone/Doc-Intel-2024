...
In the new process, Agent's will no longer receive emails w/ visitor information - instead, employees will submit their visitor request via a catalog item & attach a copy of the vistor's identification, which will trigger the workflow to engage Doc Intel.
